...
class PandasStar:
    ...
    def run(
        ...
        print(f"Running PandasAI with {self._llm.type} LLM...")
        try:
            ...
            if multiple:
                heads = [dataframe.head() for dataframe in data_frame]
            ...
            if is_conversational_answer:
                ...
                #print(f"Conversational answer: {answer}")

            return answer, code
        except Exception as exception:  # pylint: disable=broad-except
            self.last_error = str(exception)
            return "Unfortunately, I was not able to answer your question, because of the following error:\n ", str(exception)
